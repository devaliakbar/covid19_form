...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                $updateQuarantineRecordQuery = "UPDATE
                `quarantine_info`
            SET
                ...
                `lat` = '" . $body['lat'] . "',
                `lon` = '" . $body['lon'] . "',
                `orgin_country` = '" . $body['orgin_country'] . "',
                `orgin_state` = '" . $body['orgin_state'] . "',
                `orgin_district` = '" . $body['orgin_district'] . "',
                `phc_area` = '" . $body['phc_area'] . "',
                `phc_medical_officer_contact_number` = '" . $body['phc_medical_officer_contact_number'] . "',
                `place_to_vist` = '" . $body['place_to_vist'] . "',
                `departure_date` = '" . $departureDate . "',
                `arrival_date` = '" . $arrivalDate . "',
                `date_of_information_received` = '" . $informationRecievedDate . "',
                `source_of_information` = '" . $body['source_of_information'] . "',
                `panchayat_ward_no` = '" . $body['panchayat_ward_no'] . "',
                `source_of_contact_number` = '" . $body['source_of_contact_number'] . "',
                `observation_started_date` = '" . $observationStartedDate . "',
                `observation_end_date` = '" . $observationEndDate . "',
                `current_health_status` = '" . $body['current_health_status'] . "',
                `risk_categorization` = '" . $body['risk_categorization'] . "',
                `sample_to_test_taken` = '" . $body['sample_to_test_taken'] . "',
                `date_of_sample_taken` = '" . $sampleTakenDate . "',
                `result` = '" . $body['result'] . "',
                `travelled_with_positive_case` = '" . $body['travelled_with_positive_case'] . "',
                `remark` = '" . $body['remark'] . "'
            WHERE _id = '" . $body['id'] . "'";

                if (mysqli_query($conn, $updateQuarantineRecordQuery)) {
